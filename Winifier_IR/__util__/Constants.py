...
BUILD_INVERTED_INDEX_SUCCESS="Inverted Index built successfully"
BOOL_OPERATION_SUCCESS = "Boolean operation on queries performed successfully"
BOOL_OPERATION_ERROR="Boolean operation on queries not performed successfully"